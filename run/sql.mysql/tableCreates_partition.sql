...
) partition by hash(w_id) partitions 24;
...
) partition by hash(d_w_id) partitions 24;
...
) partition by hash(c_w_id) partitions 24;
...
create table bmsql_history (
  ...
  h_data   varchar(24)
) partition by hash(h_c_w_id) partitions 24;
...
) partition by hash(no_w_id) partitions 24;
...
) partition by hash(o_w_id) partitions 24;
...
) partition by hash(ol_w_id) partitions 24;
...
) partition by hash(s_w_id) partitions 24;

create tablegroup whg1 tables tpcc.bmsql_customer, tpcc.bmsql_district, tpcc.bmsql_history, tpcc.bmsql_new_order, tpcc.bmsql_order_line, tpcc.bmsql_oorder, tpcc.bmsql_stock, tpcc.bmsql_warehouse;
